...
try:
    ...
    lr_model = joblib.load('logistic_regression_model_bank.pkl')
    svc_model = joblib.load('svc_model_bank.pkl')
    knn_model = joblib.load('knn_model_bank.pkl')
except FileNotFoundError:
    st.error("Model or scaler files not found. Please ensure 'scaler.pkl', 'logistic_regression_model_bank.pkl', 'svc_model_bank.pkl', and 'knn_model_bank.pkl' are in the same directory.")
    st.stop()
